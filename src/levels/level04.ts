...
export const LEVEL_04: LevelDef = {
  id: "level-04",
  index: 3,
  title: { en: "Nimbus Startup", id: "Startup Nimbus" },
  briefing: [
    { en: "Connection established.", id: "Koneksi berhasil." },
    {
      en: "Target: a startup's staging deploy box.",
      id: "Target: deploy box staging milik sebuah startup.",
    },
    {
  ...
  successText: [
    ...
    {
      en: "You're in — deploy pipeline unlocked.",
      id: "Kamu masuk — deploy pipeline terbuka.",
    },
    { en: "LEVEL 4 COMPLETE.", id: "LEVEL 4 SELESAI." },
  ],
  parSeconds: 220,
  intro: {
    ...
    cards: [
      ...
      },
      {
        ...
        kind: "perp",
        channel: {
          en: "DM — Platform Lead to Legal",
          id: "DM — Platform Lead ke Legal",
        },
  ...
  outro: {
    ...
    cards: [
      ...
      },
      {
        ...
        kind: "victim",
        channel: {
          en: "Personal blog — unlisted, now public",
          id: "Blog pribadi — tak terdaftar, kini publik",
        },
        author: { en: "Yosef (Backend)", id: "Yosef (Backend)" },
        body: [
          {
      ...
      },
      {
        ...
        kind: "public",
        channel: {
          en: "Tech Press — Breaking",
          id: "Media Teknologi — Berita Terbaru",
        },
      ...
      ports: [
        {
          port: 22,
          service: "ssh",
          banner: "OpenSSH 8.2 | nimbus-app (staging)",
        },
      ],
      users: [
        {
          username: "deploy-bot",
          password: "Aut0Deploy#9",
          role: "deployment service account",
        },
      ],
      systemUsers: [
            ...
            children: [
              {
                ...
                content: {
                  ...
                  id:
                    "# skrip deploy utama — jangan diubah tanpa izin tim platform\n" +
                    "# login service lama dipindahkan ke sini saat migrasi\n" +
                    "# b64: [[encoded:ZGVwbG95LWJvdA==|Komentar Base64 yang ketinggalan dari dev yang ceroboh]]\n" +
                    "import subprocess\n\n" +
                    'def deploy():\n    subprocess.run(["./push.sh"])\n',
                },
              },
              ...
              },
              {
                ...
                content: {
                  ...
                  id:
                    "service: nimbus-app\n" +
                    "username: deploy-bot\n" +
                    "password_hash: [[hash:9f86d081884c7d659a2feaa0c55ad015|Hash baru setelah rotasi terakhir]]\n" +
                    "updated: 2024-06-18",
                },
              },
            ],
